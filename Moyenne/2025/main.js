...
function option_1(a) {
    if (document.getElementById("_option_1").checked) {
        document.getElementById("option_1").style.display = "table-row";
        document.getElementById("option_1_coeff").value = 2;
        OPT_1 = document.getElementById("_option_1").checked;
        if (a) {document.getElementById("1ere").rowSpan ++;}
    } else {
        document.getElementById("option_1").style.display = "none";
        document.getElementById("option_1_coeff").value = 0;
        OPT_1 = document.getElementById("_option_1").checked;
        if (a) {document.getElementById("1ere").rowSpan --;}
    }
}
...
function option_3(a) {
    if (document.getElementById("_option_3").checked) {
        document.getElementById("option_3").style.display = "table-row";
        document.getElementById("option_3_coeff").value = 2;
        OPT_3 = document.getElementById("_option_3").checked;
        if (a) {document.getElementById("1ere").rowSpan ++;}
    } else {
        document.getElementById("option_3").style.display = "none";
        document.getElementById("option_3_coeff").value = 0;
        OPT_3 = document.getElementById("_option_3").checked;
        if (a) {document.getElementById("1ere").rowSpan --;}
    }
}
...
function option_2(a) {
    if (document.getElementById("_option_2").checked) {
        document.getElementById("option_2").style.display = "table-row";
        document.getElementById("option_2_coeff").value = 2;
        OPT_2 = document.getElementById("_option_2").checked;
        if (a) {document.getElementById("Tle").rowSpan ++;}
    } else {
        document.getElementById("option_2").style.display = "none";
        document.getElementById("option_2_coeff").value = 0;
        OPT_2 = document.getElementById("_option_2").checked;
        if (a) {document.getElementById("Tle").rowSpan --;}
    }
}
...
function DNLF(a) {
    if (document.getElementById("_dnlf").checked) {
        document.getElementById("dnlf").style.display = "table-row";
        document.getElementById("dnlf_coeff").value = 20;
        _DNLF = document.getElementById("_dnlf").checked;
        if (a) {document.getElementById("Tle").rowSpan ++;}
    } else {
        document.getElementById("dnlf").style.display = "none";
        document.getElementById("dnlf_coeff").value = 0;
        _DNLF = document.getElementById("_dnlf").checked;
        if (a) {document.getElementById("Tle").rowSpan --;}
    }
}
...
function section() {
    if (document.getElementById("section").value === "aucune") {
		document.getElementById("_dnlfcb").style.display = "none";
        document.getElementById("1ere").rowSpan = 9;
        document.getElementById("Tle").rowSpan = 11;
        ...
        document.getElementById("dnlf_coeff").value = 0;
        document.getElementById("es1_coeff").value = 3;
        document.getElementById("es2_coeff").value = 3;
        document.getElementById("ecm_coeff").value = 0;
        ...
        document.getElementById("ens_1").style.display = "table-row";
        document.getElementById("ens_2").style.display = "table-row";
        document.getElementById("ecm").style.display = "none";
        document.getElementById("dnlf").style.display = "none";
    } else if (document.getElementById("section").value === "chinoise") {
		document.getElementById("_dnlfcb").style.display = "block";
        document.getElementById("1ere").rowSpan = 9;
        document.getElementById("Tle").rowSpan = 14;
        ...
        document.getElementById("litt_o_coeff").value = 10;
        document.getElementById("hg_1_coeff").value = 3;
        document.getElementById("hg_2_coeff").value = 3;
        document.getElementById("DNL_chi_1_coeff").value = 5;
        document.getElementById("DNL_chi_2_coeff").value = 5;
        document.getElementById("DNL_e_coeff").value = 5;
        document.getElementById("DNL_o_coeff").value = 5;
        document.getElementById("dnlf_coeff").value = 0;
        document.getElementById("es1_coeff").value = 0;
        document.getElementById("es2_coeff").value = 0;
        document.getElementById("ecm_coeff").value = 20;
        ...
        document.getElementById("ens_1").style.display = "none";
        document.getElementById("ens_2").style.display = "none";
        document.getElementById("ecm").style.display = "table-row";
		if (_DNLF) {
			document.getElementById("dnlf_coeff").value = 20;
			document.getElementById("dnlf").style.display = "table-row";
			document.getElementById("Tle").rowSpan ++;
		}
    } else {
		document.getElementById("_dnlfcb").style.display = "block";
        document.getElementById("1ere").rowSpan = 7;
        document.getElementById("Tle").rowSpan = 14;
        document.getElementById("LVA_1_coeff").value = 0;
        document.getElementById("LVA_2_coeff").value = 0;
        document.getElementById("litt_e_coeff").value = 10;
        ...
        document.getElementById("DNL_o_coeff").value = 10;
        document.getElementById("dnlf_coeff").value = 0;
        document.getElementById("es1_coeff").value = 3;
        document.getElementById("es2_coeff").value = 3;
        document.getElementById("ecm_coeff").value = 20;
    ...
    if (_Jury) {document.getElementById("Tle").rowSpan ++;}
}
...
function ouvrir(notes,file) {
    ...
    for (var i = 1; i < elements.length; i++) {
        if (i === 1) {
            ...
            if (notes[i] == undefined) {
                if (i === 2 || i === 3 || i === 5 || i === 61 || i === 63 || i === 64 || i === 69 || i === 72) {
					notes[i] = "false";
                } else {
					notes[i] = 0;
                }
    ...
    option_1(document.getElementById("_option_1").checked);
    option_3(document.getElementById("_option_3").checked);
    option(document.getElementById("_option").checked);
    option_2(document.getElementById("_option_2").checked);
